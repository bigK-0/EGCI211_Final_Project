...
data* sort(data *a, int N){
  ...
  for ( i = 0; i<N-1; i++){
   ...
   cout<<setw(10)<<"professor"<<setw(10)<<"age"<<setw(18)<<"heart rate(bpm)"<<endl;
  ...
  cout<<setw(10)<<"professor"<<setw(10)<<"subject"<<setw(10)<<"subject"<<setw(10)<<"age"<<setw(18)<<"heart rate(bpm)"<<endl;
  for(i=0; i<l;i++) {
    (*(low_risk+i)).print();
  }
