...
int main(int argc, char* argv[]) {
  ...
  while(exit!=1){ 
    ...
    cout<<"\t6. Show lists of professors in the selected department."<<endl;
    ...
    switch(option){
      case 1:
        ...
        else if (l==2) sci_h.insert(bus.group_high(pt_data+size));
        else if (l==3) eng_h.insert(bus.group_high(pt_data+size));
        else if (l==4) hum_h.insert(bus.group_high(pt_data+size));
        else if (l==5) ir_h.insert(bus.group_high(pt_data+size));
        else if (l==6) tour_h.insert(bus.group_high(pt_data+size));
        else if (l==7) des_h.insert(bus.group_high(pt_data+size));
